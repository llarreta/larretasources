 ...
 * 
 */
@WebService(name="AdjustmentElementsWS",targetNamespace="http://stock.business.ws.sdii.directv.com.co/")
public interface IAdjustmentElementsWS {
	 ...
	 * @author jjimenezh
	 */
	@WebMethod(operationName="updateAdjustmentElements", action="updateAdjustmentElements", exclude = true)
	public void updateAdjustmentElements(@WebParam(name="objAdjustmentElements")AdjustmentElementsVO objAdjustmentElements) throws BusinessException;
	 ...
	 * @author jjimenezh
	 */
	@WebMethod(operationName="deleteAdjustmentElements", action="deleteAdjustmentElements", exclude = true)
	public void deleteAdjustmentElements(@WebParam(name="objAdjustmentElements")AdjustmentElementsVO objAdjustmentElements) throws BusinessException;
	 ...
	 * @author jjimenezh
	 */
	@WebMethod(operationName="getAdjustmentElementsByID", action="getAdjustmentElementsByID", exclude = false)
	public AdjustmentElementsVO getAdjustmentElementsByID(@WebParam(name="id")Long id) throws BusinessException;
	 ...
	 * @author jjimenezh
	 */
	@WebMethod(operationName="getAllAdjustmentElementss", action="getAllAdjustmentElementss", exclude = true)
