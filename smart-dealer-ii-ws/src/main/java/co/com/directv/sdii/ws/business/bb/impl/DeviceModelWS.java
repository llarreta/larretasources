...
import co.com.directv.sdii.ws.business.bb.IDeviceModelWS;
 ...
 * @version 1.0
 * 
 * @see co.com.directv.sdii.facade.bb.DeviceModelFacadeBeanLocal
 */
@MTOM
@WebService(serviceName="DeviceModelWSService",
		endpointInterface="co.com.directv.sdii.ws.business.bb.IDeviceModelWS",
		targetNamespace="http://bb.business.ws.sdii.directv.com.co/",
		portName="DeviceModelWSPort")
@Stateless()
public class DeviceModelWS implements IDeviceModelWS {

	@EJB
    private DeviceModelFacadeBeanLocal ejbRef;
	 ...
	 * @author jjimenezh
	 */
	public void createDeviceModel(DeviceModelVO objDeviceModel) throws BusinessException{
		ejbRef.createDeviceModel(objDeviceModel);
	}
	 ...
	 * @author jjimenezh
	 */
	public void updateDeviceModel(DeviceModelVO objDeviceModel) throws BusinessException{
		ejbRef.updateDeviceModel(objDeviceModel);
	}
	 ...
	 * @author jjimenezh
	 */
	public void deleteDeviceModel(DeviceModelVO objDeviceModel) throws BusinessException{
		ejbRef.deleteDeviceModel(objDeviceModel);
	}
	...
	public DeviceModelVO getDeviceModelByID(Long id) throws BusinessException{
		return ejbRef.getDeviceModelByID(id);
	}
	...
	public List<DeviceModelVO> getAllDeviceModels() throws BusinessException{
		return ejbRef.getAllDeviceModels();
	}
