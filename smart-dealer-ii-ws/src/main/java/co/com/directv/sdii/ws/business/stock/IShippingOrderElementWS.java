 ...
 * 
 */
@WebService(name="ShippingOrderElementWS",targetNamespace="http://stock.business.ws.sdii.directv.com.co/")
public interface IShippingOrderElementWS {
	 ...
	 * @author jjimenezh
	 */
	@WebMethod(operationName="createShippingOrderElement", action="createShippingOrderElement", exclude = true)
	public void createShippingOrderElement(@WebParam(name="objShippingOrderElement")ShippingOrderElementVO objShippingOrderElement) throws BusinessException;
	 ...
	 * @author jjimenezh
	 */
	@WebMethod(operationName="updateShippingOrderElement", action="updateShippingOrderElement", exclude = true)
	public void updateShippingOrderElement(@WebParam(name="objShippingOrderElement")ShippingOrderElementVO objShippingOrderElement) throws BusinessException;
	 ...
	 * @author jjimenezh
	 */
	@WebMethod(operationName="deleteShippingOrderElement", action="deleteShippingOrderElement", exclude = true)
	public void deleteShippingOrderElement(@WebParam(name="objShippingOrderElement")ShippingOrderElementVO objShippingOrderElement) throws BusinessException;
	 ...
	 * @author jjimenezh
	 */
	@WebMethod(operationName="getShippingOrderElementByID", action="getShippingOrderElementByID", exclude = true)
	public ShippingOrderElementVO getShippingOrderElementByID(@WebParam(name="id")Long id) throws BusinessException;
	 ...
	 * @author jjimenezh
	 */
	@WebMethod(operationName="getAllShippingOrderElements", action="getAllShippingOrderElements")
