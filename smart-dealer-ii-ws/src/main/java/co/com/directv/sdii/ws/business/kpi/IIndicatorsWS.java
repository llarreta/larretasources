package co.com.directv.sdii.ws.business.kpi;
 ...
 * 
 */
@WebService(name="IndicatorsWS",targetNamespace="http://kpi.business.ws.sdii.directv.com.co/")
public interface IIndicatorsWS {
	 ...
	 * @author jjimenezh
	 */
	@WebMethod(operationName="createIndicators", action="createIndicators", exclude = true)
	public void createIndicators(@WebParam(name="objIndicators")IndicatorsVO objIndicators) throws BusinessException;
	 ...
	 * @author jjimenezh
	 */
	@WebMethod(operationName="updateIndicators", action="updateIndicators", exclude = true)
	public void updateIndicators(@WebParam(name="objIndicators")IndicatorsVO objIndicators) throws BusinessException;
	 ...
	 * @author jjimenezh
	 */
	@WebMethod(operationName="deleteIndicators", action="deleteIndicators", exclude = true)
	public void deleteIndicators(@WebParam(name="objIndicators")IndicatorsVO objIndicators) throws BusinessException;
	 ...
	 * @author jjimenezh
	 */
	@WebMethod(operationName="getIndicatorsByID", action="getIndicatorsByID", exclude = true)
	public IndicatorsVO getIndicatorsByID(@WebParam(name="id")Long id) throws BusinessException;
	 ...
	 * @author jjimenezh
	 */
	@WebMethod(operationName="getAllIndicatorss", action="getAllIndicatorss")
