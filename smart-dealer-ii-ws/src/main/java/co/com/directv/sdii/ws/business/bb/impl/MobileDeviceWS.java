...
import co.com.directv.sdii.ws.business.bb.IMobileDeviceWS;
 ...
 * @version 1.0
 * 
 * @see co.com.directv.sdii.facade.bb.MobileDeviceFacadeBeanLocal
 */
@MTOM
@WebService(serviceName="MobileDeviceWSService",
		endpointInterface="co.com.directv.sdii.ws.business.bb.IMobileDeviceWS",
		targetNamespace="http://bb.business.ws.sdii.directv.com.co/",
		portName="MobileDeviceWSPort")
@Stateless()
public class MobileDeviceWS implements IMobileDeviceWS {

	@EJB
    private MobileDeviceFacadeBeanLocal ejbRef;
	 ...
	 * @author jjimenezh
	 */
	public void createMobileDevice(MobileDeviceVO objMobileDevice) throws BusinessException{
		ejbRef.createMobileDevice(objMobileDevice);
	}
	 ...
	 * @author jjimenezh
	 */
	public void updateMobileDevice(MobileDeviceVO objMobileDevice) throws BusinessException{
		ejbRef.updateMobileDevice(objMobileDevice);
	}
	 ...
	 * @author jjimenezh
	 */
	public void deleteMobileDevice(MobileDeviceVO objMobileDevice) throws BusinessException{
		ejbRef.deleteMobileDevice(objMobileDevice);
	}
	...
	public MobileDeviceVO getMobileDeviceByID(Long id) throws BusinessException{
		return ejbRef.getMobileDeviceByID(id);
	}
	...
	public List<MobileDeviceVO> getAllMobileDevices() throws BusinessException{
		return ejbRef.getAllMobileDevices();
	}
