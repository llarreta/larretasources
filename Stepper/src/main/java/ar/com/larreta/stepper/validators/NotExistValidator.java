...
import ar.com.larreta.stepper.validators.annotations.NotExist;
...
public class NotExistValidator implements ConstraintValidator<Annotation, Object> {
	...
	public boolean isValid(Object field, ConstraintValidatorContext context) {
		try {
			...
			return !((Boolean) business.execute(new ExistData(notExist.entityType(), notExist.linkedField(), getValue(field)), null, null));
		} catch (Exception e){
