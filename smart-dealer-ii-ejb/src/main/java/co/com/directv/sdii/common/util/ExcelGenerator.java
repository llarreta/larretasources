    	...
    	try{
	        ...
	        for(Object objeto : dataList){
	        	...
	        	if(objeto instanceof QuantityWarehouseElementsDTO){
	        		...
	        		rowValue = 
	        				"=\"" + (itemQuantityWarehouseElementsDTO.getDealerNameCompany()!=null?itemQuantityWarehouseElementsDTO.getDealerNameCompany():" ")+"\";=\""+(itemQuantityWarehouseElementsDTO.getDealerNameBranch()!=null?itemQuantityWarehouseElementsDTO.getDealerNameBranch():" ")
