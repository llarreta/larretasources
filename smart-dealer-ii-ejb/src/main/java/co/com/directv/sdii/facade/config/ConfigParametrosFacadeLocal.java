 ...
 */
@Local
public interface ConfigParametrosFacadeLocal {
    ...
    /**
     * Trae un parametro del sistema para un codigo especifico y un pais dado
     * @param code codigo unico por pais del parametro del sistema
     * @param countryId id del pais donde se quiere buscar el parametro del sistema
     * @return
     * @throws BusinessException
     */
