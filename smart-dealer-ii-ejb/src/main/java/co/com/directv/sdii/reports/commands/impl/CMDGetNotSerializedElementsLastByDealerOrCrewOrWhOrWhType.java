...
import co.com.directv.sdii.reports.commands.CMDGetNotSerializedElementsLastByDealerOrCrewOrWhOrWhTypeLocal;
import co.com.directv.sdii.reports.commands.ICommand;

/**
 * Clase que genera un List<WarehouseElementVO> invocando el metodo
 * getWarehouseElementsByWarehouse de la clase WarehouseElementFacadeBeanLocal.
 * 
 ...
 * @see
 */
@Stateless(name = "CMDGetNotSerializedElementsLastByDealerOrCrewOrWhOrWhType", mappedName = "ejb/CMDGetNotSerializedElementsLastByDealerOrCrewOrWhOrWhType")
public class CMDGetNotSerializedElementsLastByDealerOrCrewOrWhOrWhType extends BaseCommand implements
		ICommand,CMDGetNotSerializedElementsLastByDealerOrCrewOrWhOrWhTypeLocal {
	...
	public CMDGetNotSerializedElementsLastByDealerOrCrewOrWhOrWhType() {
	}
	...
	public <T> List<T> execute(String args) throws BusinessException {
		...
		try {
			...
			WareHouseElementResponse whElementResponse = whElementFacade.getNotSerializedElementsLastByCriteria(wareHouseRequestDTO); 
