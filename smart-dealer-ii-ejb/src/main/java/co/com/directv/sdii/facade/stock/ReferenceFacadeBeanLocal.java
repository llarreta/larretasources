...
/**
 * 
 * Interfaz de la fachada con las operaciones Tipo CRUD de la Entidad Reference.
 * 
 ...
 */
@Local
public interface ReferenceFacadeBeanLocal {

	/**
	 * Metodo:  Permite crear en el sistema un objeto Reference
	 * @param obj - ReferenceVO  objeto que encapsula la información de un ReferenceVO
	...
	/**
	 * Metodo: Permite actualizar en el sistema la información de un Reference
	 * @param obj - ReferenceVO  objeto que encapsula la información de un ReferenceVO
	...
	/**
	 * Metodo: Permite borra la información de un Reference
	 * @param obj - ReferenceVO  información del ReferenceVO a ser borrado
	...
	/**
	 * Metodo: Permite consultar la información de un Reference por su identificador
	 * @param id - Long identificador del Reference a ser consultado
	...
	/**
	 * Metodo: Permite consultar la información de todos los Reference almacenados en la persistencia
	 * @return List<ReferenceVO> Lista con los ReferenceVO existentes, una lista vacia en caso que no existan ReferenceVO en el sistema
	 * @throws BusinessException en caso de error al ejecutar la consulta de todas las Reference
	 * @author gfandino
	 */
	 ...
	 * @param userId identificador del usuario loguado
	 * @throws BusinessException En caso de error al ejecutar la operación
	 * @author jjimenez
	 * 
	 */
	public void registerReferenceDeliveryAndElementMovement(Long referenceId,
			Date deliveryDate, Long targetEmployeeId, String comments, Double sentUnits, Long userId)throws BusinessException;
	 ...
	 * CU Inv-49
	 * @param dealer Long ID dealer solicita las remisiones por fecha de confirmacion
	 * @param country - Long identificador del país
