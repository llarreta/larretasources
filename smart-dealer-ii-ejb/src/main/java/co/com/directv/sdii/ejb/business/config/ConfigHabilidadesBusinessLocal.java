 ...
 */
@Local
public interface ConfigHabilidadesBusinessLocal {

        /**
     * Este método retorna una instancia de SKILLS por ID.
     *
     * @param id
     * @return
	 ...
	 * @return Lista con los tipos de habilidad registrados en el sistema
