...
import co.com.directv.sdii.reports.commands.CMDGetReferenceElementItemsByReferenceIDAndSerLocal;
 ...
 * @see
 */
@Stateless(name = "CMDGetReferenceElementItemsByReferenceIDAndSer", mappedName = "ejb/CMDGetReferenceElementItemsByReferenceIDAndSer")
public class CMDGetReferenceElementItemsByReferenceIDAndSer extends BaseCommand implements ICommand,CMDGetReferenceElementItemsByReferenceIDAndSerLocal {
	...
	public <T> List<T> execute(String args) throws BusinessException {
		try{
			...
			ReferenceElementItemsResponse reponse = ejbRefElement.getReferenceElementItemsByReferenceIDAndSerOrNotSer(refID,null,true) ;
			if(reponse != null){
