 ...
 * generated in the co.com.directv.sdii.dto.esb.dispatchtechnician package. 
...
public class ObjectFactory {
    ...
    private final static QName _RequestMetadata_QNAME = new QName("http://directvla.com/schema/util/commondatatypes/v2-0", "RequestMetadata");
    ...
    private final static QName _ResponseMetadata_QNAME = new QName("http://directvla.com/schema/util/commondatatypes/v2-0", "ResponseMetadata");
    private final static QName _Product_QNAME = new QName("http://directvla.com/schema/businessdomain/product/v1-0", "Product");
    private final static QName _ReceiveMessage_QNAME = new QName("http://directvla.com/schema/util/commondatatypes/v2-0", "ReceiveMessage");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: co.com.directv.sdii.dto.esb.dispatchtechnician
     * 
     */
    ...
    /**
     * Create an instance of {@link WithdrawWorkOrderFromTechnicianResult }
     * 
     */
    public WithdrawWorkOrderFromTechnicianResult createWithdrawWorkOrderFromTechnicianResult() {
        return new WithdrawWorkOrderFromTechnicianResult();
    }
    ...
    /**
     * Create an instance of {@link WithdrawWorkOrderFromTechnician }
     * 
     */
    public WithdrawWorkOrderFromTechnician createWithdrawWorkOrderFromTechnician() {
        return new WithdrawWorkOrderFromTechnician();
    }
    ...
    /**
     * Create an instance of {@link DispatchWorkOrderRequest }
     * 
     */
    public DispatchWorkOrderRequest createDispatchWorkOrderRequest() {
        return new DispatchWorkOrderRequest();
    }
    ...
    /**
     * Create an instance of {@link SharedApplicationCollection }
     * 
     */
    public SharedApplicationCollection createSharedApplicationCollection() {
        return new SharedApplicationCollection();
    }
    ...
    /**
     * Create an instance of {@link WorkOrderResultCollection }
     * 
     */
    public WorkOrderResultCollection createWorkOrderResultCollection() {
        return new WorkOrderResultCollection();
    }
    ...
    /**
     * Create an instance of {@link DispatchWorkOrderResponse }
     * 
     */
    public DispatchWorkOrderResponse createDispatchWorkOrderResponse() {
        return new DispatchWorkOrderResponse();
    }
    ...
    /**
     * Create an instance of {@link WorkOrderResultItem }
     * 
     */
    public WorkOrderResultItem createWorkOrderResultItem() {
    ...
    /**
     * Create an instance of {@link WithdrawWorkOrderFromTechnicianResponse }
     * 
     */
    public WithdrawWorkOrderFromTechnicianResponse createWithdrawWorkOrderFromTechnicianResponse() {
        return new WithdrawWorkOrderFromTechnicianResponse();
    }
    ...
    /**
     * Create an instance of {@link SharedApplicationItem }
     * 
     */
    public SharedApplicationItem createSharedApplicationItem() {
        return new SharedApplicationItem();
    }
    ...
    /**
     * Create an instance of {@link WithdrawWorkOrderFromTechnicianRequest }
     * 
     */
    public WithdrawWorkOrderFromTechnicianRequest createWithdrawWorkOrderFromTechnicianRequest() {
        return new WithdrawWorkOrderFromTechnicianRequest();
    }
    ...
    /**
     * Create an instance of {@link DispatchWorkOrder }
     * 
     */
    public DispatchWorkOrder createDispatchWorkOrder() {
        return new DispatchWorkOrder();
    }
    ...
    /**
     * Create an instance of {@link DispatchWorkOrderResult }
     * 
     */
    public DispatchWorkOrderResult createDispatchWorkOrderResult() {
        return new DispatchWorkOrderResult();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link RequestMetadataType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://directvla.com/schema/util/commondatatypes/v2-0", name = "RequestMetadata")
    public JAXBElement<RequestMetadataType> createRequestMetadata(RequestMetadataType value) {
        return new JAXBElement<RequestMetadataType>(_RequestMetadata_QNAME, RequestMetadataType.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://directvla.com/schema/util/commondatatypes/v2-0", name = "ResponseMetadata")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://directvla.com/schema/util/commondatatypes/v2-0", name = "ReceiveMessage")
