package co.com.directv.sdii.ejb.business.security;
...
/**
 * Interfaz que define los métodos de negocio para el módulo de seguridad .
 * @since 28/05/2010
 * @author Jimmy Vélez Muñoz
 *
 */
@Local
public interface SecurityBusinessBeanLocal {
	...
	/**
	 * Metodo: Obtiene el usuario configurado por defecto paraa notificaciones a IBS
	...
	/**
	 * Metodo: Método que permite eliminar todos los registros de Profile dado el Rol.
	 * @param rol  - RolVO
	 * @throws BusinessException
	 * @author gfandino
	 */
	...
	/**
	 * Metodo: Método que permite crear una lista completa de Profiles para un Rol.
	 * @param profiles - List<ProfileVO>
	 * @throws BusinessException 
	 * @author gfandino
	 */
	...
	/**
	 * Metodo: Obtiene una lista de usuarios por login o número de documento
	 * @param login
	 * @param docNumber
	 ...
	 * @author wjimenez
	 */
	public List<UserVO> getUsersByRoleTypeCodeAndCountryId(String roleTypeCode, Long countryId) throws BusinessException;
