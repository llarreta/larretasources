 ...
 */
@Local
public interface ProgramStatusCRUDBeanLocal {
	
	/**
	 * Crea un estado de programa en el sistema
	 * @param obj Estado de programa que se creará en el sistema
	 ...
	 * @param id Id del estado del programa
	 ...
	 * @param obj Estado de programa que se actualizará en el sistema
	 * @throws BusinessException
	 */
	 ...
	 * @param obj Estado de programa que se eliminará del sistema
	 * @throws BusinessException
	 */
