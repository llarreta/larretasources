...
public class ProfileSaver extends ABMSaver {
	...
	public ProfileSaver() {
		...
		mainScreen = new MainScreen(ScreenImplementationsIds.PROFILE_MAIN, abmClass, DeleteResourceMessageListener.class.getName()) {
		...
		createScreen = new CreateScreen(ScreenImplementationsIds.PROFILE_CREATE, abmClass, ChangeResourceMessageListener.class.getName()) {
		...
		updateScreen = new UpdateScreen(ScreenImplementationsIds.PROFILE_UPDATE, abmClass, ChangeResourceMessageListener.class.getName()) {
