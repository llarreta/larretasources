...
insert into [SCHEMMA].security (id, avaiable, loginPage, loginProcessingUrl, defaultSuccessUrl, failureUrl, usernameParameter, passwordParameter, logoutUrl, logoutSuccessUrl, deleteCookies) 
						values (1, false, '/app/login', '/app/j_spring_security_check', '/app/home', '/app/login', 'username', 'password', '/app/logout', '/app/login', 'JSESSIONID');
...
insert into [SCHEMMA].securityMatcher (id, matcherType, pattern, idSecurity) values (5, 'permitAll', '/**', 1);
