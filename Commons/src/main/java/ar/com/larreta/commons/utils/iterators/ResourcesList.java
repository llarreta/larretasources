...
/**
 * Obtiene recursos que se encuentren a partir de un patron
 */
public class ResourcesList extends AppObjectImpl {
    /**
    ...
    public static Collection<String> getResourcesFromJarFile(final File file, final Pattern pattern){
        final ArrayList<String> retval = new ArrayList<String>();
        ZipFile zf;
        try{
            zf = new ZipFile(file);
