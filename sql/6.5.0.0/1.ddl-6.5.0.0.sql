...
CREATE INDEX CREW_MODIFICATIONS_IDX02 ON CREW_MODIFICATIONS (trunc(MODIFICATION_CREW_DATE));
...
CREATE INDEX WO_CREW_ATTENTIONS_IDX02 ON WORK_ORDER_CREW_ATTENTIONS ( WO_CODE );

CREATE INDEX WO_CREW_ATTENTIONS_IDX03 ON WORK_ORDER_CREW_ATTENTIONS (TRUNC(ATTENTION_DATE));
...
CREATE INDEX UPLOAD_FILE_PARAM_IDX1 ON UPLOAD_FILE_PARAMS("UPLOAD_FILE_ID");

CREATE INDEX FILE_DETAIL_PROCESSES_IDX1 on FILE_DETAIL_PROCESSES("FILE_ID");

CREATE INDEX ADJUSTMENT_ELEMENTS_IDX02 ON ADJUSTMENT_ELEMENTS ( WAREHOUSE_DESTINATION_ID  );
